frequencylist = ['2120', '2177', '2235', '2292', '2350']
parameternamelist = ['S11', 'S12', 'S21', 'S22']
filenamelist = []
rowdict = {'c=0.135': (3, 1003), 'c=0.140': (1007, 2007), 'c=0.145': (2011, 3011), 'c=0.150': (3015, 4015)}
fileindex = 0
...
def getvariablename(fileindexinp):
	...
	return 'Fr' + frequencypart + parameternamepart + 'M'
...
scipy.io.savemat('simulationresults_MATCHED.mat', simulationresultsdict)
