frequencylist = ['2185', '2186']
parameternamelist = ['S12']
filenamelist = []
...
def getvariablename(fileindexinp):
	frequencypart = frequencylist[fileindexinp // 1]
	parameternamepart = parameternamelist[fileindexinp % 1]
	return 'Fr' + frequencypart + parameternamepart

for frequency in frequencylist:
	for parametername in parameternamelist:
		newfilename = 'F' + frequency + parametername + '.txt'
...
scipy.io.savemat('simulationresultsFINAL.mat', simulationresultsdict)
